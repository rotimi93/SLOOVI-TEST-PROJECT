...
client = MongoClient(os.getenv("mongodb://michael93:michael93@cluster0-shard-00-00.cjdew.mongodb.net:27017,"
                               "cluster0-shard-00-01.cjdew.mongodb.net:27017,cluster0-shard-00-02.cjdew.mongodb.net:27017/?ssl=true&replicaSet=atlas-uxulln-shard-0&authSource=admin&retryWrites=true&w=majority"))
db = client.sloovi
...
def register():
	...
	try:
		...
		f = new_user[fName,lName,email,pwd]
